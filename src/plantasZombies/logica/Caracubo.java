...
public class Caracubo {
    ...
    * @param fila Fila en la que aparecerá el zombie caracubo
    * @param columna Columna en la que aparecerá el zombie caracubo
    */
    public Caracubo(int fila, int columna){
        this.x = fila;
        this.y = columna;
        this.resistencia = 10; //Aguanta 8 golpes
        this.daño = 1; //Hace 1 de daño a las plantas
        this.velocidad = 4; //Se mueve 1 casillas cada 4 turnos
    }
